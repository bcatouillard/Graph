// Librairie de scripts JS Cerner
        ...
        */
        ...
        function APPLINK( mode, appname, param ){
             ...
             if (paramLength > 2000){
                 document.getElementById("__ID_CCLPostParams_8288__").value = '"' + param + '"';
                 param = param.substring(0, 2000);
             }
             var el = document.getElementById("__ID_CCLLINKHref_27345__");
        ...
        function MPAGES_EVENT( eventType, eventParams ){
             ...
             if (paramLength > 2000){
                 document.getElementById("__ID_CCLPostParams_8288__").value = '"' + eventParams + '"';
